...
- [x] make export of webp work
- [x] make export of pdf work
- [x] make export of eps work: Impossible!
- [x] add proper documentation to entire new code

- [x] add a binary as an example to show how to use the new staticly crate even without any plotly specific code, just json stuff 
- [x] write a nice parser using json serialize/deserialize for capabilities, like you found on the othe rrepo
...
- [x] implement download of webdriver(s) using something like webdriver_download 
