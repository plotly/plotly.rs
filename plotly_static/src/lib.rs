...
//!
//! This library provides a high-level interface for converting Plotly JSON
//! plots into various static image formats (PNG, JPEG, WEBP, SVG, PDF) using
//! WebDriver and headless browsers.
//!
//! ## Features
//!
//! - **Multiple Formats**: Support for PNG, JPEG, WEBP, SVG, and PDF export
//! - **Headless Rendering**: Uses headless browsers for high-quality rendering
//! - **WebDriver Support**: Supports both Chrome (chromedriver) and Firefox
//!   (geckodriver)
//! - **Configurable**: Customizable dimensions, scale, and browser options
//! - **Offline Mode**: Can work with bundled JavaScript libraries
//! - **Automatic Management**: Handles WebDriver process lifecycle and cleanup
//! - **Parallel Safety**: Designed for use in parallel environments (tests,
//!   etc.)
...
//!
//! This library provides several advantages over Kaleido:
//!
//! - **No External Dependencies**: Uses standard WebDriver instead of
//!   proprietary Kaleido
//! - **Better Browser Support**: Works with any WebDriver-compatible browser
//! - **Parallel Safety**: Designed for parallel environments
//! - **Extensible**: Easy to add new browser capabilities and features
//!
//! ## Limitations
//!
//! - Requires a WebDriver-compatible browser
//! - PDF export uses browser JavaScript (not native Plotly PDF)
//! - EPS format is deprecated and will be removed
//! - Slightly slower than Kaleido for single operations (but faster for batch
//!   operations)
//!
//! ## License
//!
...
/// functionality from third-party libraries, not the native Plotly PDF export.
///
/// # Supported Formats
///
...
///     0.13.0 has been generting empty images.
///
/// # Examples
///
/// ```rust
...
///
/// This builder provides a fluent interface for configuring WebDriver settings,
