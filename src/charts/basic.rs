    ...
    Y: num::Num + Serialize,
{
    ...
    pub fn ids(mut self, ids: Vec<String>) -> Box<Scatter<X, Y>> {
        self.ids = Some(ids);
        Box::new(self)
    }
    pub fn text(mut self, text: Vec<String>) -> Box<Scatter<X, Y>> {
        self.text = Some(text);
        Box::new(self)
    }
    pub fn text_position(mut self, text_position: Position) -> Box<Scatter<X, Y>> {
        self.text_position = Some(text_position);
        Box::new(self)
    }
    pub fn text_template(mut self, text_template: Dim<String>) -> Box<Scatter<X, Y>> {
        self.text_template = Some(text_template);
        Box::new(self)
    }
    pub fn hover_text(mut self, hover_text: Dim<String>) -> Box<Scatter<X, Y>> {
        self.hover_text = Some(hover_text);
        Box::new(self)
    }
    pub fn hover_info(mut self, hover_info: &str) -> Box<Scatter<X, Y>> {
        self.hover_info = Some(hover_info.to_owned());
        Box::new(self)
    }
    pub fn hover_template(mut self, hover_template: Dim<String>) -> Box<Scatter<X, Y>> {
...
//     Z: num::Num + Serialize, {}
//
// impl<X, Y, Z> TraceSerialize for Scatter3D<X, Y, Z>
// where
//     X: num::Num + Serialize,
//     Y: num::Num + Serialize,
//     Z: num::Num + Serialize,
    ...
    Y: num::Num + Serialize,
{
    ...
    text: Option<Vec<String>>,
    #[serde(skip_serializing_if = "Option::is_none", rename = "textposition")]
    text_position: Option<Vec<String>>,
    #[serde(skip_serializing_if = "Option::is_none", rename = "texttemplate")]
    text_template: Option<Dim<String>>,
    #[serde(skip_serializing_if = "Option::is_none", rename = "hovertext")]
    hover_text: Option<Dim<String>>,
    ...
    Y: num::Num + Serialize,
{
    ...
    pub fn ids(mut self, ids: Vec<String>) -> Box<Bar<X, Y>> {
        self.ids = Some(ids);
        Box::new(self)
    }
    ...
    pub fn offset(mut self, offset: Dim<usize>) -> Box<Bar<X, Y>> {
        self.offset = Some(offset);
        Box::new(self)
    }

    pub fn text(mut self, text: Vec<String>) -> Box<Bar<X, Y>> {
        self.text = Some(text);
        Box::new(self)
    }

    pub fn text_position(mut self, text_position: Vec<String>) -> Box<Bar<X, Y>> {
        self.text_position = Some(text_position);
        Box::new(self)
    }

    pub fn text_template(mut self, text_template: Dim<String>) -> Box<Bar<X, Y>> {
        self.text_template = Some(text_template);
        Box::new(self)
    }

    pub fn hover_text(mut self, hover_text: Dim<String>) -> Box<Bar<X, Y>> {
        self.hover_text = Some(hover_text);
        Box::new(self)
    }

    pub fn hover_info(mut self, hover_info: &str) -> Box<Bar<X, Y>> {
        self.hover_info = Some(hover_info.to_owned());
        Box::new(self)
    }

    pub fn hover_template(mut self, hover_template: Dim<String>) -> Box<Bar<X, Y>> {
        self.hover_template = Some(hover_template);
        Box::new(self)
    }
